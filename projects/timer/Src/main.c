 ...
 *                      every 1 second, driven by Timer3's update events.
 * 
...
int main(void)
{
    ...
    /* Initialize Timer 3 for 1-second update events */
	timer3Init();

	const char *string = "1 second has passed\n\r"; // Message to be transmitted
